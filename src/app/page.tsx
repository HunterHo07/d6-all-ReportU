        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <div ref={ctaRef} className="flex flex-col sm:flex-row gap-4 mb-8">
              <Link href="/report" className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium rounded-full hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-center">
                Report an Incident
              </Link>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <Link href="#" className="text-indigo-200 hover:text-white transition-colors">About</Link>
              <Link href="#" className="text-indigo-200 hover:text-white transition-colors">Privacy</Link>
              <Link href="#" className="text-indigo-200 hover:text-white transition-colors">Terms</Link>
              <Link href="#" className="text-indigo-200 hover:text-white transition-colors">Contact</Link>
            </div>
          </div>
